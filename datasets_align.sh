...
# Process VCTK
mfa validate "$PWD/datasets/vctk-prepared" english_mfa english_mfa -t "$PWD/.mfa/" -j 16
mfa align "$PWD/datasets/vctk-prepared" english_mfa english_mfa "$PWD/datasets/vctk-aligned" -t "$PWD/.mfa/" -j 16
